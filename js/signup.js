...
signupForm.addEventListener("submit", (e) => {
  ...
  const nameUsr = localStorage.setItem("nameUsr", nombre);
  ...
  const Users =
    JSON.parse(localStorage.getItem("users")) || []; /* en el caso de que el storage tenga usuarios, los guarda, sino va a tenr un array vacío*/
